...
* ~~`PROJECT=Allwinner DEVICE=H616 ARCH=aarch64 UBOOT_SYSTEM=x96q make image`~~ (no defconfig in U-Boot 2025.07)
* ~~`PROJECT=Allwinner DEVICE=H616 ARCH=aarch64 UBOOT_SYSTEM=yuzukihd-chameleon make image`~~ (no defconfig in U-Boot 2025.07)
